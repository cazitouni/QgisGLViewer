        ...
        if result == QDialog.Accepted :
            ...
            if isinstance(connection, tuple) :
                ...
                try:
                    ...
                    if result == QDialog.Accepted:
                        geom, yaw, link, date, low_degree = second_dialog.get_columns()
                        params = {'conn': conn, "geom":geom, "yaw": yaw, "link":link, "date":date, "schema":schema, "table":table, "crs": project_crs, "low_degree": low_degree}
                        return params
                    else:
                        pass
                except Exception:
                ...
                if result == QDialog.Accepted:
                    geom, yaw, link, date, low_degree = second_dialog.get_columns()
                    params = {'conn': conn, "geom":geom, "yaw": yaw, "link":link, "date":date, "table": layer, "schema": connection, "crs": project_crs, "low_degree": low_degree}
                    return params
                else:
                    pass
